            ...
            <div class="white_shd full margin_bottom_30">
               ...
               <form method="POST" class="row">
                  ...
                  <div class="row" style="margin-left:0px;">
                     ...
                     <label for="selected_date">Filter:</label>
                        <input type="text" id="userFilter" style="width:142.5%" style="margin-left:10px" class="form-control" placeholder="Search here..." onkeyup="filterTable()">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <button type="submit" class="btn btn-primary" style="margin-left: 15px;">Show result</button>
                  </div>
               ...
               <div class="table_section padding_infor_info">
                  <div class="table-responsive-sm" style="font-size:large;">
                           ...
                           <tbody>
                              ...
                              if ($usersResult->num_rows > 0) {
                                 while ($userRow = $usersResult->fetch_assoc()) {
                                       ...
                                       // Query to fetch activities for the user on the selected date
                                       $activityQuery = "
                                          SELECT 
                                             start_time, 
                                             end_time, 
                                       ...
                                       if ($activityResult->num_rows > 0) {
                                          // Concatenate activities for the user
                                          $activities = "";
                                          ...
                                          while ($activityRow = $activityResult->fetch_assoc()) {
                                             ...
                                             $activities .= "$startTime &emsp; - &emsp; $endTime : &emsp; $activity<br><br>";
                                          }
                                          ...
                                          echo "<tr>";
                                          echo "<td>$username</td>";
                                          echo "<td>No activities for this date</td>";
                                          echo "</tr>";
                                       }
                                 }
                              } else {
