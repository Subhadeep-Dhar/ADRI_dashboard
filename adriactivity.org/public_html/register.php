                        ...
                        <form method="POST" action="register.php">
                            <fieldset>
                                ...
                                <div class="field">
                                    ...
                                    <input type="email" name="email" placeholder="Enter your organisation email" pattern=".+@(adriindia\.org|adriindiaadmin\.org)$" value="<?php echo isset($_SESSION['form_data']['email']) ? $_SESSION['form_data']['email'] : ''; ?>" required />

                                    <script>
function validateEmail() {
  const email = document.getElementById("email").value;
  const emailRegex = /.+@(adriindia\.org|adriindiaadmin\.org)$/;
  
  if (!emailRegex.test(email)) {
    alert("Please enter a valid ADRI email (e.g., example@adriindia.org or example@adriindiaadmin.org)");
