...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>ADRI dashboard | Develper</title>
               ...
               <div class="login_form">
                  ...
                  <div class="developer_info">
                     <div class='info_block'>
                        <p><strong>Name:</strong> Subhadeep Dhar</p>
                        <!-- <p><strong>Phone:</strong> +91 90830 09315</p> -->
                        <p><strong>Email:</strong> subhadeepdhar563@gmail.com</p>
                        <p><strong>Education:</strong> Bachalor’s in Computer Application</p>
                        <p><strong>Address:</strong> Alipurduar, West Bengal, India</p>
                     </div>
                  </div>
                  ...
                  <div class="developer_info">
                     <div class='info_block'>
                        <p><strong>Name:</strong> Isha Tapader</p>
                        <!-- <p><strong>Phone:</strong> +91 83718 03078</p> -->
                        <p><strong>Email:</strong> ishatapader1999@gmail.com</p>
                        <p><strong>Education:</strong> Bachalor’s in Computer Application</p>
                        <p><strong>Address:</strong> Chakdaha, West Bengal, India</p>
                     </div>
                  </div>
